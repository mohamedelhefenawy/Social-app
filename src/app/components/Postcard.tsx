...
function PostCard({ post, dbUserId }: { post: Post; dbUserId: string | null }) {
  ...
  const handleAddComment = async () => {
    ...
    try {
      ...
      const result = await togglecomment(post.id, newComment);
      if (result?.success) {
        ...
        <div className="space-y-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between">
                ...
                {dbUserId === post.author.id && (
                  <DeleteAlert isDeleting={isDeleting} onDelete={handleDeletePost} />
                )}
              </div>
          ...
          {post.image && (
            <div className=" rounded-lg overflow-hidden">
              <Image src={post.image} alt="Post content" className="object-cover rounded-lg " width={300} height={100}/>
            </div>
          )}
